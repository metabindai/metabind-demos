 ...
 */
package ai.metabind.retail.demo.data
...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "metabind_retail")
 ...
 * DataStore does not, so uninstalling is a reset here. That is deliberate for a
 * sample; a production app should issue short-lived per-user credentials from a
 * backend rather than persisting a shared key at all.
 */
@Singleton
